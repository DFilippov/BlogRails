  ...
  received: function received(data) {
    ...
    $(document).ready(function () {
      $("#comment_body_".concat(data[comment_id])).on('turbolinks:load', function () {
        var commentLabel = document.getElementById("comment_body_".concat(data[comment_id])); // commentLabel.innerHTML = data['comment_body'];
...
/******/ });
//# sourceMappingURL=application-fa0948f4e58632bddd4b.js.map