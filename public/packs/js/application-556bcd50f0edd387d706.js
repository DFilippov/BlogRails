...
document.addEventListener('turbolinks:load', function () {
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("CommentChannel", {
    ...
    received: function received(data) {
      ...
      comment_body.innerText = data['comment_body']; // $(`#comment_body_${data['comment_id']}`).innerHTML = data['comment_body']
...
/******/ });
//# sourceMappingURL=application-556bcd50f0edd387d706.js.map