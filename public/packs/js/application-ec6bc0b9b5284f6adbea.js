...
function destroyCommentInfo(comment) {
  var commenter = comment['author'];
  var commentShadow = document.getElementById("shadow-".concat(comment['id']));
  commentShadow.innerHTML = "" + "<i>Commenter: ".concat(commenter, "</i>") + "<i style='color: red'>DELETED THIS COMMENT</i>";
}
...
/******/ });
//# sourceMappingURL=application-ec6bc0b9b5284f6adbea.js.map