...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("CommentChannel", {
  ...
  received: function received(data) {
    ...
    console.log(data['comment_id'], "===", data['comment_body']); // const comment_body = document.getElementById(`comment_body_${data[comment_id]}`);
    // comment_body.innerText =
    // $(`#comment_body_${data['comment_id']}`).innerHTML = data['comment_body']
...
/******/ });
//# sourceMappingURL=application-8548262596dd9b9a1f89.js.map