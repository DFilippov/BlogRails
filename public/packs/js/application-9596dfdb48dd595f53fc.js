...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("CommentChannel", {
  ...
  received: function received(data) {
    ...
    console.log(data['comment_id'], "===", data['comment_body']);
    $("#comment_body_".concat(data[comment_id])).html = data[comment_body];
    var commentLabel = document.getElementById("comment_body_".concat(data[comment_id]));
    commentLabel.innerText = data[comment_body]; // $(document).ready(function () {
    //
    //     $(`#comment_body_${data[comment_id]}`).on('turbolinks:load', function() {
    //         const commentLabel = document.getElementById(`comment_body_${data[comment_id]}`);
    //         // commentLabel.innerHTML = data['comment_body'];
    //         $(this).value = data['comment_body'];
    //         console.log(data['comment_body'])
    //     })
    // })
  }
});
...
/******/ });
//# sourceMappingURL=application-9596dfdb48dd595f53fc.js.map